...
`rmf_fleet_msgs` will not break public ABI within a major version number.
...
`rmf_fleet_msgs` uses DCO as its confirmation of contributor origin policy. More information can be found in [CONTRIBUTING](../CONTRIBUTING.md).

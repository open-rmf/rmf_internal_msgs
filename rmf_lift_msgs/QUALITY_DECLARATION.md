...
`rmf_lift_msgs` will not break public ABI within a major version number.
...
`rmf_lift_msgs` uses DCO as its confirmation of contributor origin policy. More information can be found in [CONTRIBUTING](../CONTRIBUTING.md).
